...
import { Settings, Percent, Calendar, Users, CreditCard, Save, AlertTriangle } from 'lucide-react';
...
export function SystemSettings({ state, updateState }: SystemSettingsProps) {
  const [interestRate, setInterestRate] = useState(state.interestRate.toString());
  ...
  const stats = {
    ...
    activeMembers: state.users.filter(u => u.role === 'member' && u.status === 'active').length,
    ...
    totalContributions: state.contributions.reduce((sum, cont) => sum + cont.amount, 0),
    pendingNotifications: state.notifications.filter(n => n.status === 'pending').length
  };
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Configure system parameters and view statistics</p>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <div className="space-y-1 text-sm text-blue-800">
                ...
                <p>• Interest split equally: {parseFloat(interestRate) / 2}% per payment</p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">{formatCurrency(stats.totalLoanAmount)}</span>
                </div>
                <div className="flex justify-between items-center">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            How the loan payment system works
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm">
                <p>• Payments are made <strong>twice monthly</strong></p>
                <p>• Payment dates: <strong>15th and 30th</strong> of each month</p>
                <p>• For a 6-month loan = <strong>12 total payments</strong></p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p>• Current rate: <strong>{state.interestRate}% annually</strong></p>
                <p>• Per payment: <strong>{state.interestRate / 2}%</strong> of principal</p>
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            ...
            <div className="text-sm space-y-1">
              <p>Loan Amount: $10,000 | Term: 6 months | Rate: {state.interestRate}%</p>
              <p>Total Payments: 12 (twice monthly for 6 months)</p>
              <p>Principal per payment: $10,000 ÷ 12 = $833.33</p>
              <p>Interest per payment: $10,000 × {state.interestRate / 2}% = ${(10000 * state.interestRate / 2 / 100).toFixed(2)}</p>
              <p>Total per payment: $833.33 + ${(10000 * state.interestRate / 2 / 100).toFixed(2)} = ${(833.33 + (10000 * state.interestRate / 2 / 100)).toFixed(2)}</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="grid md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <div className="text-lg font-bold">{state.interestRate}% annually</div>
