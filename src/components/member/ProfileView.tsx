        ...
        <Dialog open={updateRequestOpen} onOpenChange={setUpdateRequestOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                You can only request updates to your mobile number and email
                address. Other changes require admin approval.
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              ...
              <div className="flex justify-end space-x-2">
                <Button
                  variant="outline"
                  onClick={() => setUpdateRequestOpen(false)}
                >
                  Cancel
                </Button>
                <Button onClick={handleUpdateRequest}>Submit Request</Button>
              </div>
            </div>
          </DialogContent>
        </Dialog>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-sm text-blue-800">
                <strong>Update Requests:</strong> You can request updates to
                your mobile number and email address using the "Request Update"
                button. All other profile changes must be made by the system
                administrator.
              </p>
            </div>
          </div>
